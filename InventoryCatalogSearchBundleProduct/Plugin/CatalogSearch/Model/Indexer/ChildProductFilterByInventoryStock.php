...
namespace Magento\InventoryCatalogSearchBundleProduct\Plugin\CatalogSearch\Model\Indexer;
...
/**
 * Filter bundle products by stock status.
 */
class ChildProductFilterByInventoryStock
{
    ...
    /**
     * Filter out of stock options for bundle product.
     *
    ...
    /**
     * Filtering by stock status of bundle child products to select
     *
     * @param Select $select
     * @param string $stockTable
     * @return void
    ...
    private function addStockFilterByChildProducts(Select $select, string $stockTable)
    {
        ...
        $existsSelect->join(
            ...
            "bundle_product_child.{$linkField} = child_product_status.{$linkField}"
        ...
        $existsSelect->join(
            ...
            'product_link_bundle.parent_product_id = product.entity_id'
        );
